...
function Reports() {
  ...
  const handleDownload = (type) => {
    ...
    if (type === 'json') exportAsJson(reportData, filename);
    else if (type === 'csv') exportAsCsv(reportData, filename);
  };

  const isLoading = utils.isLoading('getDailySummary') || utils.isLoading('getPeriodSummary');
          ...
          <div id="print-area">
            ...
            <div className="p-6 bg-gray-50 rounded border shadow-inner">
              ...
              <div className="mt-8 flex gap-3 print:hidden">
                ...
                <button onClick={() => handleDownload('json')} className="flex items-center gap-2 px-4 py-2 bg-gray-700 text-white rounded hover:bg-gray-800">
                  <FileJson size={18} /> Download JSON
                </button>
                <button onClick={() => handleDownload('csv')} className="flex items-center gap-2 px-4 py-2 bg-gray-700 text-white rounded hover:bg-gray-800">
