        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-2xl border border-white/20">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              />
              {errors.email && (
                <p id="email-error" role="alert" className="text-red-300 text-xs mt-1 flex items-center gap-1">
            ...
            <div>
              ...
              {errors.password && (
                <p id="password-error" role="alert" className="text-red-300 text-xs mt-1 flex items-center gap-1">
                  <AlertCircle className="w-3 h-3" />
                  {errors.password}
                </p>
              )}
