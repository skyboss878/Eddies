...
export const apiEndpoints = {
  ...
  estimates: {
    ...
    convertToJob: (id) => mutateOrQueue("post", `/api/auth/estimates/${id}/convert-to-job`, {}),
  ...
  invoices: {
    ...
    markPaid: (id) => mutateOrQueue("post", `/api/auth/invoices/${id}/mark-paid`, {}),
  ...
  timeclock: {
    ...
    clockIn: () => mutateOrQueue('post', '/api/auth/timeclock/clock-in', {}),
    clockOut: () => mutateOrQueue('post', '/api/auth/timeclock/clock-out', {}),
  ...
  settings: {
    ...
    updateShop: (data) => mutateOrQueue('put', '/api/auth/settings/shop', data),
    shop: {
      get: () => api.get('/api/auth/settings/shop'),
      update: (data) => mutateOrQueue('put', '/api/auth/settings/shop', data)
    }
  },
  ...
  ai: {
    ...
    diagnosis: (data) => mutateOrQueue('post', '/api/ai/diagnostics', data),
