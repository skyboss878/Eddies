// src/pages/CustomerList.jsx - FIXED VERSION using customerService
...
import { customerService } from '../utils/services/customerService'; // Import all named exports
...
const CustomerList = () => {
  ...
  // FIXED: Restore page state only on mount
  useEffect(() => {
  ...
  // FIXED: Memoized save state function
  ...
  // FIXED: Fetch customers using service
  useEffect(() => {
    fetchCustomers();
  }, []);
  ...
  const fetchCustomers = useCallback(async () => {
    try {
      ...
      // Use customerService.getAll() for authenticated requests
  ...
  const handleDeleteCustomer = useCallback(async (customer, e) => {
    ...
    try {
      // Use customerService.delete() for authenticated deletion
  ...
  const handleBulkDelete = useCallback(async () => {
    ...
    try {
      // Use customerService for bulk deletion with proper method name
      await Promise.all(
        selectedCustomers.map(id => customerService.delete(id))
      );
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      {/* Customer List/Grid - Simplified for now */}
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="text-sm font-medium text-gray-900">{customer.vehicle_count} vehicles</p>
