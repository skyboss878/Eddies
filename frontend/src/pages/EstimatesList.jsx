...
const exportToCSV = () => {
  try {
    ...
    // Convert estimates into CSV rows
    const csvData = itemsToExport.map(est => ({
    ...
    // Build CSV string
    const csvContent = [
      ["Customer Name", "Vehicle Info", "Status", "Total", "Date"],
    ...
    if (document.body) {
      ...
      // Fallback if document.body isn't available
      link.click();
    }
