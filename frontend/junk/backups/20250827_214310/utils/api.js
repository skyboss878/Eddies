...
// Base URL
const API_BASE_URL = import.meta.env?.VITE_API_BASE_URL || "http://192.168.1.26:5000";
...
const healthApi = axios.create({
  baseURL: "http://192.168.1.26:5000", baseURL: "http://192.168.1.26:5000"

// Helper function for auth headers (FIXED: was missing)
...
const apiEndpoints = {
  ...
  // Appointments (FIXED: now uses api instance consistently)
  appointments: {
...
// Migration Service (FIXED: now uses api instance)
...
// Appointments (ADDED: missing legacy functions)
...
export const appointmentService = apiEndpoints.appointments; // ADDED: was missing
