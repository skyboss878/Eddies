// src/pages/Landing.jsx - Eddie's Automotive Beautiful Website
      ...
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-slate-800 text-white font-sans overflow-x-hidden">
        ...
        <div className="relative overflow-hidden pt-16 pb-32 md:pt-24 md:pb-48 lg:pt-32 lg:pb-64">
          ...
          <div className="absolute inset-0 z-0">
            <div className="absolute inset-0 bg-gradient-to-r from-red-700/30 to-blue-700/30"></div>
            {/* Animated racing stripes */}
            <div className="absolute top-0 -left-1/4 w-32 h-full bg-white/10 transform -skew-x-12 opacity-70"></div>
            <div className="absolute top-0 left-1/4 w-24 h-full bg-red-500/10 transform -skew-x-12 opacity-70"></div>
            <div className="absolute top-0 -right-1/4 w-32 h-full bg-white/10 transform skew-x-12 opacity-70"></div>
            <div className="absolute top-0 right-1/4 w-24 h-full bg-blue-500/10 transform skew-x-12 opacity-70"></div>
          </div>
          ...
          <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              ...
              >
                🛠️ Staff Login - Shop Management System
              </button>
              <button
          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-8 md:mb-12">
              {[
                ...
                <div key={index} className="bg-gray-800/80 backdrop-blur-sm p-6 md:p-8 rounded-xl shadow-lg border border-gray-700 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:bg-gray-800 relative overflow-hidden service-card">
        ...
        <div className="bg-gradient-to-r from-gray-900 to-black py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-6 drop-shadow-lg">About "Fast Eddie"</h2>
            <div className="max-w-4xl mx-auto text-lg text-gray-300 space-y-4">
              <p>Eddie's passion for racing translates into lightning-fast, professional service for your vehicle. With over 30 years of experience, "Fast Eddie" has built a reputation for quality work and honest service in Bakersfield.</p>
              <div className="bg-red-900/20 border-l-4 border-red-500 p-4 my-6 text-left">
                <h3 className="text-xl font-bold text-red-300 mb-2">Why Choose Eddie's Automotive?</h3>
                <ul className="space-y-2 text-gray-300">
                  ...
                  <li>✅ Racing expertise applied to every job</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-80 modal-backdrop flex items-center justify-center z-50 p-4">
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-8 max-w-md w-full border-2 border-red-500 shadow-2xl">
            <div className="flex justify-between items-center mb-6">
              ...
              <button onClick={() => closeModal('staff')} className="text-gray-400 hover:text-red-400 text-2xl">×</button>
            </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-80 modal-backdrop flex items-center justify-center z-50 p-4">
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-8 max-w-lg w-full border-2 border-blue-500 shadow-2xl max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-6">
              ...
              <button onClick={() => closeModal('customer')} className="text-gray-400 hover:text-blue-400 text-2xl">×</button>
            </div>
