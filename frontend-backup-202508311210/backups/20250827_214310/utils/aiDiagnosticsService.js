...
export const aiDiagnosticsService = {
  ...
  generateComprehensiveDiagnosis: async (diagnosticData) => {
    try {
      const response = await api.post('/api/ai/diagnostics/comprehensive', diagnosticData);
  ...
  generateQuickDiagnosis: async (data) => {
    try {
      const response = await api.post('/api/ai/diagnostics/quick-diagnosis', data);
      return response.data;
    } catch (error) {
      throw error;
    }
  ...
  lookupOBDCodes: async (codes) => {
    try {
      const response = await api.post('/api/ai/diagnostics/obd-lookup', { codes });
      return response.data;
    } catch (error) {
      throw error;
    }
